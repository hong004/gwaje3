...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // ── 1. 학생 등록 ──────────────────────────────────────────
            if (menu.equals("1")) {
                System.out.print(" 등록할 학생,대학원생의 이름을 입력: ");
                String name = sc.nextLine();
                System.out.print("연구실 이름을 입력: ");
                String labName = sc.nextLine();
                System.out.print("지도교수 이름을 입력: ");
                String advisor = sc.nextLine();

                GraduateStudent newGrad = new GraduateStudent(name, labName, advisor);
                studentList.add(newGrad);
                System.out.println("학생이 등록되었습니다. 학번은 " + newGrad.getStudentId() + "입니다.");
